...
public class GroupLokasiHController extends ParentController{
	...
	public void initBinder(WebDataBinder binder) {
		binder.setValidator(new GroupLokasiHValidator());
	}
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("grouplokasih_sys_tgl_create_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
	}
