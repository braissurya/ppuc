...
public class UserController extends ParentController {
	...
	public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size,
			...
			@RequestParam(value = "sortOrder", required = false) String sortOrder,@RequestParam(value = "group", required = false) String group, Model uiModel) {
		if (page == null) {
			page = 1;
		}
		...
		uiModel.addAttribute("userList", userManager.selectPagingList(search, sortFieldName, sortOrder, firstResult, sizeNo,group));
		float nrOfPages = (float) userManager.selectPagingCount(search,group) / sizeNo;
